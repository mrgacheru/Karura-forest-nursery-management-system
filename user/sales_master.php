    ...
    <div id="content">
        ...
        <div id="content-header">
            <div id="breadcrumb"><a href="#" class="tip-bottom"><i class="icon-home"></i>
                    <h1>Sale a products</h1></a></div>
        </div>

        <div class="container-fluid"style="margin-left:300PX;margin-top:0px;padding-top:20px;">

                <div class="row-fluid" style="background-color: white; min-height: 100px; padding:10px;">
                    <div >
                        <div class="widget-box"style="margin-left:0px;padding-right:10px;">
                            <div class="widget-title"><span class="icon"> <i class="icon-align-justify"></i> </span>
                                <h1>Sale a Products</h1>
                            </div>
                    ...
                    <div class="span12">
                        ...
                        <div class="span1">
                            <div>
                                <label>&nbsp</label>
                                <center> 
                                    <input  type="button" class="span11 btn btn-success" value="Add" onclick="add_session();"style="background-color:brown; width:150px; height:32px">
                                </center>
                            </div>
                        </div>
            ...
            <div class="row-fluid" style="background-color: white; min-height: 100px; padding:10px;">
                <div class="span12">
                   ...
                   <div id="bill_products"></div>
                    ...
                    <h4>
                        <div style="float: right"><span style="float:left;">Total:ksh</span><span style="float: left" id="totalbill">0</span></div>
                    </h4>
                    ...
                    <center>
                        <input style="background-color:brown;height:32px;width:130px;border-radius:7px;height:px"type="submit" name="submit1" value="Generate bill" class="btn btn-success">
                    </center>
