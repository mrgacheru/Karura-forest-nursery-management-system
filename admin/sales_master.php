...
?>
    ...
    <div id="content">
        ...
        <div class="container-fluid">
                ...
                <div class="row-fluid" style="background-color: white; min-height: 100px; padding:10px;margin-left:350px;margin-top:70px;">
                    <div class="span1">
                ...
                <!-- new row-->
                <div class="row-fluid" style="background-color: white; min-height: 100px; padding:10px; margin-left:350px;">
                    <div class="span12">
