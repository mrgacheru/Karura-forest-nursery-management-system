    ...
    <div id="content">
        ...
        <div id="content-header">
            <div id="breadcrumb"><a href="#" class="tip-bottom"><i class="icon-home"></i>
                    <h2>Sale a products</h2></a></div>
        </div>

        <div class="container-fluid"style="margin-left:300PX;margin-top:0px;padding-top:40px;">
            ...
            <div class="row-fluid" style="background-color: white; min-height: 100px; padding:10px;">
                <div class="span12">
                   ...
                   <div id="bill_products"></div>
                    ...
                    <center>
                        <input style="background-color:brown;color:white;width:130px;border-radius:7px;height:px"type="submit" name="submit1" value="generate bill" class="btn btn-success">
                    </center>
